...
<div class="speeb-wrapper">
<div id="speeb_outer">
<span class="speeb_api_txt">API Key:</span>
<input type="text" name="api_key" id="api_key" class="speeb_text_box" />
...
<span class="speeb_api_txt">Wordpress User Name:</span><input type="text" name="username" id="textfield" class="speeb_text_box" value="<?php echo $current_user->user_login ; ?>" /><br>

<span class="speeb_api_txt">Wordpress Password:</span><input type="password" name="password" id="textfield" class="speeb_text_box" />
&nbsp;&nbsp;&nbsp;<input type="submit" class="button-speeb-authentication" value="Save" name="authentication_json" style="background:#333333; font-family:Arial, Helvetica, sans-serif; color:#FFFFFF" /><br><br><br><br>
...
<table width="100%" border="0" align="left" cellpadding="4" cellspacing="4">
  ...
  <tr>
    ...
    <td width="300" align="left" valign="middle"><table width="100%" border="0" align="center" cellpadding="1" cellspacing="1">
      <tr>
        <td height="30" align="center" valign="middle" class="speeb_inside_text"><b>&nbsp;</b></td>
      </tr>

	  <tr>
        <td align="center" valign="middle" bgcolor="#66CC00" class="speeb_heading2"> 
		Speeb Reachable :<?php if($up['response']['code']==200) { ?> Ok <?php } else { ?> Error <?php } ?>
		</td>
      </tr>
